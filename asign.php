...
<body>
     ...
     <br>
        ...
        <div class="g">
          <br>
             <form  class="m form-horizontal" method="POST" action="asign.php">
                ...
                <img src="per.png"  class="img-responsive">
                 ...
                 <input type="submit" class=" l btn btn-primary btn-group-horizontal" value="Login" name="submit">
                        ...
                        <div class="col-xm-3 ">
                           ...
                           <a href="newuser1.php" class=" q btn btn-group-horizontal">New User Registration</a>
                                      </div>
                                </div><br>
 ...
 <?php
      if (isset($_POST["submit"])) 
      {
        ...
        if ($name!=""&&$password!="")
        {
          $sql="SELECT USERNAME,PASSWORD FROM alumini WHERE USERNAME='$name' AND PASSWORD='$password'";
          $result=$con->query($sql);
          if ($result->num_rows>0) {
            $_SESSION["name"]=$name;
             header("location:home1.php");
             mail("bhavanirangasamy@gmail.com","alumini","$name has been logged in");
